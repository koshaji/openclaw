...
```
  ...
  <Accordion title="Limits, retry, and CLI targets">
    - `channels.telegram.textChunkLimit` default 4000; `channels.telegram.streaming.chunkMode="newline"` (under `streaming.*`) prefers paragraph boundaries (blank lines) before length splitting.
